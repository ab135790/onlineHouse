...
<div class="b-index-w" style="padding-bottom:50px;">
	...
	<div class="index-button">
		<div style="float:left;width:50%;height:46px;line-height:46px;background:#2a7dd2; text-align:center" id="allowRgxz"  onclick="openJac2()">
			...
			<img id='selectimg' style="
			position:relative;top:-2px;left:5px" src="/project/ds/images/indexxydefuault.png"  onclick="ckboxRgxz_fun()" />
	...
	<div id="J-bottom2" style="display: none">
		<div class="i-dc-w">
			<div class="dc-w-cont rgxzText" id="rgxzText2" style="padding-top:0px">
				<p>
					1.本次开盘正式在线选房时间为：<br />2018年xx月xx日xx:xx，<br />
					登录收藏时间：2018年xx月xx日xx:xx，<br /> <span
						style="color: #ff0000; font-weight: bold">正式开盘时间:2018年xx月xx日xx:xx-xx:xx<br /></span>
...
<script id="userMsg1" type="text/html">
	<div class="xm-peplet">
		<div class="userInfo">
			<p class="xm-p1 txt">姓名:<span style="color:#777777;">{{D_Name}}</span></p>
			<p class="Codes txt ml2r">中签号:<span style="color:#777777;">{{ballotnum}}</span></p>
			<p class="txt ml2r"><span class="group">第<span class="mr_5lr">{{groupnum}}</span>组</span></p>
		</div>
