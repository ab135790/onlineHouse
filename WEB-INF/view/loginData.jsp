	...
	<div class="b-index-w">
		...
		<div class="login-w" style="padding-top: 0px;">
			<div class="login-list clearfix">
				...
				<div class="login-list2">
					<input type="number" oninput="if(value.length>11)value=value.slice(0,11)" maxlength="11"  id="D_Tel" name="D_Tel" placeholder="请输入登记时的手机号码">
				</div>
			</div>

			<div class="login-list clearfix" id="code">
				<div class="login-list1"><span class="lsep2"></span></div>
				<div class="login-list2 login-list22">
					<input type="number" oninput="if(value.length>4)value=value.slice(0,4)" id="D_Code" name="D_Code" maxlength="4" placeholder="请输入验证码">
				</div>
...
<%--			onclick="onSubmit()"--%>
			...
			<div id="tips">
				<div class="tips">
					...
					<p class="mb1r tips_time"></p>
					<%-- 2020年3月30日9:00-11:30 --%>
					<p class="mb1r tips_start">温馨提示：申购人在<span class="_hour">9</span>点之前登陆</p>
					<div class="tips_attachment">
						<a href="javascript:void(0);" onclick="alertFile(event)" class="txt">《预售方案》</a>
						<a href="javascript:void(0);" onclick="alertFile(event)" class="txt">《五证公式》</a>
						<a href="javascript:void(0);" onclick="alertFile(event)" class="txt">《其他公式》</a>
					</div>
				</div>
				<div class="mask" id="mask" onclick="_public_com.closeMask('mask', 'active')">
					<div id="alertfile" class="imgMask"></div>
					<i class="layer-icon layui-icon-close closeBtn" onclick="_public_com.closeMask('mask', 'active')"></i>
				</div>
			</div>
		</div>
	</div>
