				  ...
				  function agreeYNdo(img){
					  ...
					  if($(img).attr('src').indexOf('dddefuaultselect')==-1){
						  console.log("1");
						  agreeXftz = true;
						  $(".buy").attr("style","background-color:#fa4e2a");
						  $(this).attr('src','/project/ds/images/dddefuault.png?r='+Math.random());
					  }else{
						  console.log("2");
				          agreeXftz = false;
						  //$(img).attr('isck','0');
                          $(this).attr('src','/project/ds/images/dddefuaultselect.png?r='+Math.random());						  
